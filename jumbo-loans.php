                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="about__img-wrap-three">
                            <img src="assets/img/115-scaled-e1592372387547.webp" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about__content-three">
                            <div class="section-title mb-25 tg-heading-subheading animation-style3">
                                <h2 class="title tg-element-title">Get more buying power with a Jumbo Loan!</h2>
                            </div>
                            ...
                            <div class="about-bottom about-bottom-two">
                                <div class="about__phone">
                                    <div class="content">
                                        <a class='btn btn_clss' href='jumbo-loans-quote.php'>Jumbo Loan Qualifier!</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-12">
                        <div class="about__content-three">
                            <div class="section-title mb-25 tg-heading-subheading animation-style3">
                                <h2 class="title tg-element-title">About Jumbo Home Loans</h2>
                            </div>
                            ...
                            <p>We’re here to make the jumbo home loan process easier, with tools and knowledge that will help guide you along the way, starting with our <a href="###"><strong>Jumbo Loan Qualifier.</strong></a></p>
                            ...
                            <ul>
                            	<li>Complete our simple  <a href="###">Jumbo Loan Qualifier</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="about__content-three box_xxx">
                            <div class="section-title tg-heading-subheading animation-style3 h2">
                                ...
                                <a class='btn btn_clss' href='jumbo-loans-quote.php'>I Want My FREE VA Loan Quote!</a>
                            </div>                           
                        </div>
                    </div>
