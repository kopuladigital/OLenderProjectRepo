        ...
        <div class="container">
          <div class="row">
            <div class="services__content-four card">
                  <h3 style="margin-bottom: 15px;">FREE Home Purchase Qualifier</h3>
                  <p>Do you know how much home you can afford? Take the <br>first step by getting pre-qualified here for FREE!</p>
                        ...
                        <!--============Step-1==============-->
                              ...
                              <div class="card">
                                ...
                                <div class="plans">
                                    <label class="plan basic-plan" for="rb_06">
                                      <input type="radio" name="purches_home" id="rb_06" value="Yes"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                                          <span>Yes</span>
                                        </div>
                                    ...
                                    <label class="plan complete-plan" for="rb_07">
                                      <input type="radio" id="rb_07" name="purches_home" value="No"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                                          <span>No</span>
                                        </div>
                          ...
                          <div class="step-form-step">
                              <div class="card">
                                ...
                                <div class="plans">
                                    <label class="plan basic-plan" for="rbr_10">
                                      <input type="radio" name="property" id="rbr_10" value="Primary Home"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                                    ...
                                    <label class="plan complete-plan" for="rbr_11">
                                      <input type="radio" id="rbr_11" name="property" value="Secondary Home"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                                    ...
                                    <label class="plan complete-plan" for="rbr_12">
                                      <input type="radio" id="rbr_12" name="property" value="Investment"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                          ...
                          <div class="step-form-step">
                              <div class="card">
                                ...
                                <div class="form-group doll_inpt">
                                  <label>What is your estimated down payment?</label>
                                  <input type="number" class="form-control" id="mortgage" name="mortgage" placeholder="00">
                                  <span>%</span>
                          ...
                          <div class="step-form-step">
                              <div class="card">
                                <div class="form-group doll_inpt">
                                  ...
                                  <input type="number" class="form-control" id="" name="" placeholder="00.00">
                                  <span>$</span>
                                  <p class="error hide" id="error-estimate">this field required.</p>                               
                                </div>
                          ...
                          <div class="step-form-step">
                              <div class="card">
                                ...
                                <div class="plans">
                                    ...
                                    <label class="plan complete-plan" for="rbr_20">
                                      <input type="radio" id="rbr_20" name="refinance" value="Better rate"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                                          <span>Other</span>
                                        </div>
                          ...
                          <div class="step-form-step">
                              <div class="card">
                                ...
                                <div class="plans">
                                    <label class="plan basic-plan" for="rbr_27">
                                      <input type="radio" name="income" id="rbr_27" value="Yes"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                                          <span>Yes</span>
                                        </div>
                                    ...
                                    <label class="plan basic-plan" for="rbr_28">
                                      <input type="radio" name="income" id="rbr_28" value="No"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                                          <span>No</span>
                                        </div>
                          ...
                          <div class="step-form-step">
                              <div class="card">
                                ...
                                <div class="plans">
                                    <label class="plan basic-plan" for="rbr_027">
                                      <input type="radio" name="income" id="rbr_027" value="Yes"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                                          <span>Yes</span>
                                        </div>
                                    ...
                                    <label class="plan basic-plan" for="rbr_028">
                                      <input type="radio" name="income" id="rbr_028" value="No"/>
                                      <div class="plan-content">
                                        <div class="plan-details">
                                          <span>No</span>
                                        </div>
