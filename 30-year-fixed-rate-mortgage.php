                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="breadcrumb__content">
                            <h2 class="title">30 year Fixed Mortgage</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="about__img-wrap-three">
                            <img src="assets/img/30-year-mortgage-rates-scaled-e1712208991628.webp" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about__content-three">
                            ...
                            <div class="about-bottom about-bottom-two">
                                ...
                                <div class="about__phone">
                                    <div class="content">
                                         <a class='btn btn_clss' href='#'>30 year Fixed Qualifier!</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="about__content-three box_xxx">
                            <div class="section-title tg-heading-subheading animation-style3 h2">
                                ...
                                <a class='btn btn_clss' href='#'>I Want My FREE 30-Year Fixed Rate Quote!</a>
                            </div>                           
                        </div>
                    </div>
