                    ...
                    <div class="col-lg-6">
                        <div class="banner__content-two_2 h2_cls">
                            ...
                            <ul>
                                ...
                                <li><i class="fas fa-hand-point-right"></i> <a href="###">Blanket Loans</a></li>
                                <li><i class="fas fa-hand-point-right"></i> <a href="###">Commercial Investment Mortgages</a></li>
                                <li><i class="fas fa-hand-point-right"></i> <a href="###">Business Line of Credit</a></li>
