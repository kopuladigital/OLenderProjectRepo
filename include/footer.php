                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                            <div class="footer-widget">
                                ...
                                <div class="footer-link-list">
                                    <ul class="list-wrap">
                                        <li><a href='terms-of-use.php'> Terms of Service</a></li>
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="footer-link-list">
                                    <ul class="list-wrap">
                                        ...
                                        <li><a href='residential-mortgage.php'>Residential Mortgage</a></li>
                                        <li><a href='commercial-mortgage.php'>Commercial Mortgage</a></li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="copyright-text">
                                <p>Copyright © <?php echo date("Y");?> <a href='index.php'>OLLender</a> | All Right Reserved |
                                   <a href="https://www.eofferup.com/" target="_blank"> Designed & Developed by eOfferUp</a> |
                                   <a href="https://edgehomefinance.com/" target="_blank"> Powered by EDGE HOMEFINANCE</a> 
                                </p>
                            </div>
                        </div>
                    </div>
