                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="breadcrumb__content">
                            <h2 class="title">Reverse Mortgage</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="about__img-wrap-three">
                            <img src="assets/img/reverse_mortgage_types_2x.jpg" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="about-bottom about-bottom-two">
                                ...
                                <div class="about__phone">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="tel:(786) 835-7247">(786) 835-7247</a> | <a class='btn btn_clss' href='#'>Reverse Mortgage Qualifier!</a>
                                    </div>
                                </div>
                            </div>
